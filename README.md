...
## 🎯 Layihənin məqsədi  
Bu layihə bank müştərilərinin məlumatları əsasında **kredit götürmə ehtimalını** və ya **kreditin ödənmə qabiliyyətini** modelləşdirməyi hədəfləyir.  
...
-  **seaborn** — statistik vizuallaşdırma  
